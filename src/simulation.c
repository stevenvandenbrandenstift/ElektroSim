...
static void elektro_sim_simulation_reset_options (ElektroSimSimulation* self);
GtkBox* elektro_sim_component_get_grid (ElektroSimComponent* self);
static void elektro_sim_simulation_reset_dc_options (ElektroSimSimulation* self);
static void elektro_sim_simulation_change_dc_sources (ElektroSimSimulation* self, gint option);
...
ElektroSimSimulation* elektro_sim_simulation_construct (GType object_type, gint option) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = elektro_sim_component_add_parameter ((ElektroSimComponent*) self, "time", (gdouble) 0, "s", ELEKTRO_SIM_PARAMETER_WIDGET_STYLE_LABEL, ELEKTRO_SIM_PARAMETER_WIDGET_STYLE_NONE, _tmp2_);
	_tmp4_ = _tmp3_;
