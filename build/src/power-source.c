...
void elektro_sim_power_source_reset_options (ElektroSimPowerSource* self);
GtkBox* elektro_sim_component_get_grid (ElektroSimComponent* self);
void elektro_sim_power_source_reset_random_options (ElektroSimPowerSource* self);
void elektro_sim_power_source_change_random_type (ElektroSimPowerSource* self, gint option);
